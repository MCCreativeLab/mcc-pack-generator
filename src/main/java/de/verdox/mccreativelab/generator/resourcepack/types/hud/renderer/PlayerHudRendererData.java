...
public class PlayerHudRendererData {
    ...
    public PlayerHudRendererData(Audience player) {
        this.player = player;
    }
    ...
    public Component buildRendering() {
        ...
        for (ActiveHud value : cache.values()) {
            ...
            value.forEachElementBehavior((activeHudRenderedHudElementBehavior, rendered, audience) -> activeHudRenderedHudElementBehavior.whileOpen(value, rendered, audience), true, player);
